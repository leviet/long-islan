...
&nbsp;|&nbsp;<span class="glyphicon glyphicon-off"></span>&nbsp;<a href="logout">Logout</a> 
&nbsp;|&nbsp;<span class="glyphicon glyphicon-cog"></span>&nbsp;<a href="pass">Change password</a><h5> 
      <!-- Main component for a primary marketing message or call to action -->
      <div class="panel panel-info">
       <header class="panel-heading"><h4> Welcome to LongIsland territories!</h4></header>
        <div class="panel-body">
       <p><b>Below is a list of territories currently in your possession.</b></p>

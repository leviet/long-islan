...
<s:include value="header.jsp"/>
 <h5 class="text-right"><span class="glyphicon glyphicon-user"></span><s:property value="#session.a" />&nbsp;|&nbsp;
      ...
      <div class="panel panel-info">
        <header class="panel-heading"><h4>Stop territory circulation</h4></header>
        <br>
        
        <div class="panel-body">
         <p><b>Below is a list of territories that are currently in circulation.</b></b> 
         <br>  
        ...
        <th id="download" class="text-center">Uncirculate</th>
        ...
        <td headers="download" class="text-center">
          <form method="post" action="uncirculate-success">
          ...
          <input type="hidden" name="terrisname2" value="<s:property value="date"/>" />
          
        <button class="btn btn-primary" value="<s:property value="id"/>" name="password" type="submit"><span class="glyphicon glyphicon-remove-circle"></span>&nbsp;Uncirculate</button>
      </form>
        </td>
        </tr>
        </s:iterator>
        ...
        <th id="name" class="text-center">Territory#</th>
        <th id="date" class="text-center">Last worked</th>
        <th id="download" class="text-center">Circulate</th>

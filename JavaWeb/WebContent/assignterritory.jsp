...
<h5 class="text-right"><span class="glyphicon glyphicon-user"></span><s:property value="#session.a" />&nbsp;|&nbsp;
      ...
      <div class="panel panel-info">
       <header class="panel-heading"><h4>Territory assignments</h4></header>
        ...
        <%boolean bool=false; %>
        <s:set var="bool"><s:property value="insertsuccess"/></s:set>
        <s:if test="#bool=='true'">
	           <p class="text-success">Territory <b><s:property value="#session.d" /></b> 
               has been successfully assigned to you.Below is a list of territories currently assigned to you.</p>
       </s:if>
        <s:else>
                <p class="text-danger">Territory <b><s:property value="#session.d" /></b> 
                was not assigned to you because the system does not assign more than 3 territories to one publisher.
                Please complete one territory assigned to you first, and return it to get a new one. Below is a list of territories currently assigned to you.</p>
       </s:else>

...
<s:include value="header.jsp"/>
 <h5 class="text-right"><span class="glyphicon glyphicon-user"></span><s:property value="#session.a" />&nbsp;|&nbsp;
      ...
      <div class="panel panel-info">
        <header class="panel-heading"><h4>Delete territory</h4></header>
        <br>
        ...
        <th id="date1" class="text-center">Delete</th>
        ...
        <td headers="date" class="text-center text-nowrap"><s:property value="date"/></td>
         <td headers="date1" class="text-center">
         <form method="post" action="delete-territory-success">
          <input type="hidden" name="name" value="<s:property value="name"/>" />         
        <button class="btn btn-primary" value="<s:property value="id"/>" name="id" type="submit">Delete</button>
      </form>
      </td>
        </tr>
        </s:iterator>
        ...
        <th id="name" class="text-center">Territory#</th>
        <th id="date" class="text-center">Last worked?</th>
        <th id="download" class="text-center">Delete</th>

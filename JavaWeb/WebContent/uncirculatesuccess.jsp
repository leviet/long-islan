...
<h5 class="text-right"><span class="glyphicon glyphicon-user"></span><s:property value="#session.a" />&nbsp;|&nbsp;
     ...
     <div class="panel panel-info">
       <header class="panel-heading"><h4>Uncirculate territor</h4></header>
        <div class="panel-body">
       <br><br>
	<p><b class="text-success">Territory with name "<s:property value="terrisname"/>" has been successfully removed from circulation</b></p>
